...
package parser.beaver.spec.parser;

import parser.beaver.Parser;
import parser.beaver.ParsingTables;
	...
	protected Symbol invokeReduceAction(int rule_num, int offset) {
		switch(rule_num) {
			...
			case 23: // import = IMPORT txt_list.names SEMI
			{
					...
					final Symbol[] names = _list_names == null ? new Symbol[0] : (Symbol[]) _list_names.toArray(new Symbol[_list_names.size()]);
			...
			case 29: // terminals = TERMINALS sym_list.symbols SEMI
			{
					...
					final Symbol[] symbols = _list_symbols == null ? new Symbol[0] : (Symbol[]) _list_symbols.toArray(new Symbol[_list_symbols.size()]);
